...
Submit:
Gui, Submit, NoHide
Run, "report.exe" -t notumoverflow@gmail.com -f EngineBugReports@gmail.com -ssl -port 465 -auth -smtp smtp.gmail.com -sub subject -M "%BugReport%  {  %MACHINE_ID%  }   {  DATE/TIME:  %DateAndTime%  }   {  BODY:  %BugContents%  }" -user EngineBugReports@gmail.com -pass hz6vrxon?~Mi0nszduDO,,Hide
Sleep, 500
Gui, Destroy
